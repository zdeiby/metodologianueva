...
class c_finalizaciont1refuerzo2 extends Controller
{
...
// IR A LA VISTA BIENESTAR FISICO Y EMOCIONAL
    ...
    public function fc_actualizacionnovedadest1refuerzo2(Request $request,$folio){
        if (!session('nombre')) {
    ...
    public function fc_informevisitat1refuerzo2(Request $request,$folio){
        if (!session('nombre')) {
            // Si no existe la sesión 'usuario', redirigir al login
            return redirect()->route('login');
        }
    ...
    public function fc_finalizaciont1refuerzo2(Request $request,$folio){
        if (!session('nombre')) {
            // Si no existe la sesión 'usuario', redirigir al login
            return redirect()->route('login');
        }
