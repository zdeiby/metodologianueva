...
namespace App\Http\Controllers\editarintegrantesyhogar;
...
class c_editarhogardatosgeograficos extends Controller
{
    ...
    public function fc_encuestahogardatosgeograficos(Request $request,$folio){
        ...
        $leerintegrantes= $modelo->m_leerintegrantes($decodedFolio);
        ...
        foreach ($preguntas as $value) {
          ...
          return view('editarintegrantesyhogar/v_editarhogardatosgeograficos',["variable"=>$decodedFolio, 
          "folio"=>$folio,
          'sino'=>$sino,
