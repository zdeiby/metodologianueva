...
class c_finalizaciont2refuerzo1 extends Controller
{
...
// IR A LA VISTA BIENESTAR FISICO Y EMOCIONAL
    ...
    public function fc_actualizacionnovedadest2refuerzo1(Request $request,$folio){
        if (!session('nombre')) {
         ...
         $herramientas = new m_herramientas();
            ...
            return view('espaciodefinalizaciont2refuerzo1/v_actualizacionnovedadest2refuerzo1',  $datos,['variable'=>$folio,
    ...
    public function fc_informevisitat2refuerzo1(Request $request,$folio){
        if (!session('nombre')) {
            // Si no existe la sesión 'usuario', redirigir al login
            return redirect()->route('login');
        }
         ...
         $herramientas = new m_herramientas();
            ...
            return view('espaciodefinalizaciont2refuerzo1/v_informevisitat2refuerzo1',  $datos,['variable'=>$folio,
                                                                    'folio'=>$encodedFolio[0],
                                                                    'foliomenu'=>$encodedFolio[0],
                                                                     'tabla'=>$tabla, 'linea'=>$linea,
                                                                     'paso'=>$paso,
    ...
    public function fc_finalizaciont2refuerzo1(Request $request,$folio){
        if (!session('nombre')) {
            // Si no existe la sesión 'usuario', redirigir al login
            return redirect()->route('login');
        }
         ...
         $herramientas = new m_herramientas();
            ...
            return view('espaciodefinalizaciont2refuerzo1/v_finalizaciont2refuerzo1',  $datos,['variable'=>$folio,
                                                                    'folio'=>$encodedFolio[0],
                                                                    'foliomenu'=>$encodedFolio[0],
                                                                     'tabla'=>$tabla,'linea'=>$linea,
                                                                     'paso'=>$paso
     ...
     public function fc_agregarpasohogargeneral(Request $request){
      ...
      public function fc_finalizarvisitat2refuerzo1(Request $request){
        $now = Carbon::now();
        $folio = $request->input('folio');
        $linea = $request->input('linea');
