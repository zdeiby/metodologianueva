...
class c_indicadorest2refuerzo1 extends Controller
{

    public function fc_indicadorest2refuerzo1(Request $request,$folio){
        if (!session('nombre')) {
         ...
         $herramientas = new m_herramientas();
           ...
           $tabla = 't1_oportunidad_integrantes';
            ...
            return view('espaciodefinalizaciont2refuerzo1/v_indicadorest2refuerzo1', ['variable'=>$folio,
