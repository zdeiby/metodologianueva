...
class c_indicadorest1refuerzo1 extends Controller
{

    public function fc_indicadorest1refuerzo1(Request $request,$folio){
        if (!session('nombre')) {
         ...
         $herramientas = new m_herramientas();
           ...
           $tabla = 't1_oportunidad_integrantes';
            ...
            return view('espaciodefinalizaciont1refuerzo1/v_indicadorest1refuerzo1', ['variable'=>$folio,
