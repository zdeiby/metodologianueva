...
class c_finalizaciont1refuerzo3 extends Controller
{
...
// IR A LA VISTA BIENESTAR FISICO Y EMOCIONAL
    ...
    public function fc_actualizacionnovedadest1refuerzo3(Request $request,$folio){
        if (!session('nombre')) {
         ...
         $herramientas = new m_herramientas();
            ...
            return view('espaciodefinalizaciont1refuerzo3/v_actualizacionnovedadest1refuerzo3',  $datos,['variable'=>$folio,
    ...
    public function fc_informevisitat1refuerzo3(Request $request,$folio){
        if (!session('nombre')) {
            // Si no existe la sesión 'usuario', redirigir al login
            return redirect()->route('login');
        }
         ...
         $herramientas = new m_herramientas();
            ...
            return view('espaciodefinalizaciont1refuerzo3/v_informevisitat1refuerzo3',  $datos,['variable'=>$folio,
                                                                    'folio'=>$encodedFolio[0],
                                                                     'tabla'=>$tabla, 'linea'=>$linea,
                                                                     'paso'=>$paso,
    ...
    public function fc_finalizaciont1refuerzo3(Request $request,$folio){
        if (!session('nombre')) {
            // Si no existe la sesión 'usuario', redirigir al login
            return redirect()->route('login');
        }
         ...
         $herramientas = new m_herramientas();
            ...
            return view('espaciodefinalizaciont1refuerzo3/v_finalizaciont1refuerzo3',  $datos,['variable'=>$folio,
                                                                    'folio'=>$encodedFolio[0],
                                                                     'tabla'=>$tabla,'linea'=>$linea,
                                                                     'paso'=>$paso
                                                                    ]);
     ...
     public function fc_guardarfinalizacionest1refuerzo3(Request $request)
     {
