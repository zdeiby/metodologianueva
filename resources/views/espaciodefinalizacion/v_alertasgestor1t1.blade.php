...
function verDescripcion(id) {
   ...
   $('#siguiente').click(function(){
        var url = "../rombovisitatipo1/<?= $foliocodificado ?>"; window.location.href = url;
      }); 
      function redirectToIntegrantes() {
           var folio = `<?=$foliocodificado ?>`;
           var url = "../indicadores/:folio";
       ...
       $('#bienestarsaludemocionalqt').click(function(){var url = "../ficherodeoportunidades/<?= $foliocodificado ?>"; window.location.href = url;})
    $('#legalqt').click(function(){var url = "../ficherodeoportunidadeshogar/<?= $foliocodificado ?>"; window.location.href = url;})
    $('#indicadores').click(function(){var url = "../indicadores/<?= $foliocodificado ?>"; window.location.href = url;})
    $('#alertas').click(function(){var url = "../alertasgestor1t1/<?= $foliocodificado ?>"; window.location.href = url;})
</script>
