  ...
  <div class="accordion-item" id="l1e1">
    <div class="accordion-header" id="headingOne">
      <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
        <div>
          <span class="badge bg-primary" style="font-size:15px">FINANCIERO QT</span>
            ...
            <div class="tab-pane fade active show" id="home" role="tabpanel" aria-labelledby="identificacion">
              <form id="formulario" class="row g-3 was-validated">
                ...
                @php
                  ...
                  $gi1 = ($indicador_bf_1=='0');
                  $gi2 = ($indicador_bf_2=='0');
                  $gi3 = ($indicador_bf_3=='0');
                  $gf4 = ($indicador_bf_4=='0' && $representante=='SI');
                  $gf5 = ($indicador_bf_5=='0');

                  $giCount = ($gi1?1:0)+($gi2?1:0)+($gi3?1:0);
                  $gfCount = ($gf4?1:0)+($gf5?1:0);

                  $giCol = ($giCount==1)? 'col-12' : 'col-12 col-md-6';
                  $gfCol = ($gfCount==1)? 'col-12' : 'col-12 col-md-6';

                  $hayFinanciero = $gi1 || $gi2 || $gi3 || $gf4 || $gf5;
                @endphp
                ...
                @else
                  ...
                  {{-- ===== GENERACIÓN DE INGRESOS (bf1–bf3) ===== --}}
                  @if($giCount>0)
                    <span class="badge bg-primary" style="font-size:15px; background:#a80a85 !important">Generación de ingresos</span>
                    <div class="container mt-4">
                      <div class="border">
                        ...
                        <div class="row g-0">
                          ...
                          @if($gi3)
                            <div class="{{ $giCol }} p-2">
                              <div class="row g-0" id="indicadorbf3">
                                <div class="col-md-12 d-flex align-items-center border-end border-bottom">
                                  <div class="p-2">
                                    Las personas de 18 años y más que lo requieren se vinculan a un empleo formal (cruce institucional, validación de gestor)
                                    @if($vista != '1')
                                      <div class="text-center mt-3">
                                        <div class="btn btn-success" onclick="abrirmodal('<?= $indicadores_tabla[31]->id_bienestar ?>','<?= $indicadores_tabla[31]->id_subcategoria ?>','<?= $indicadores_tabla[31]->id_indicador ?>')">Mover Indicador</div>
                                      </div>
                                    @endif
                                  </div>
                                </div>
                  ...
                  {{-- ===== GESTIÓN FINANCIERA (bf4–bf5) ===== --}}
                  @if($gfCount>0)
                    <span class="badge bg-primary" style="font-size:15px; background:#ff8403 !important">Gestión financiera</span>
                    <div class="container mt-4">
                      <div class="border">
                        <div class="row g-0">
                          <div class="col-md-12 d-flex align-items-center border-end border-bottom text-center" style="background:#2fa4e7; color:white; font-weight:bold">
