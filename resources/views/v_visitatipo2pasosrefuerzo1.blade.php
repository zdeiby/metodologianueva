          ...
          <div class="card">
            <div class="content">
              ...
              <div class="back">
                ...
                <button type="button" id="gestionintegrantes" <?= (($existel600p60010 == '1' && $existel600p60020 == '0' ) /* || ($existel600p60010 == '1' && $existel600p60030 == '0') || ($existel600p60010 == '1' && $existel600p60040 == '0') */  )?'':'disabled'?>  class="btn btn-primary" onclick="window.location.href='../momentoconcientet2refuerzo1/{{$folioencriptado}}/'">Ir a momento movilizador.</button>
                <div class="smCard">
                </div>
              </div>
            </div>
