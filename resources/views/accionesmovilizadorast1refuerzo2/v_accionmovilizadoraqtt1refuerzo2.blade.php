    ...
    <script>
      ...
      $('#siguiente').click(function(){
            ...
            $.ajax({
                ...
                success: function(response) {
                  ...
                  url = "../accionmovilizadoracompromisost1refuerzo2/<?= $variable ?>"; window.location.href = url;
                  }else{
                    Swal.fire({
                      icon: "error",
                      title: "Oops...",
     ...
     //   var url = "../rombovisitatipo1/<?= $variable ?>"; window.location.href = url;
      ...
      function redirectToIntegrantes() {
           var folio = `<?=$variable ?>`;
           var url = "../bienestarenfamiliat1refuerzo2/:folio";
