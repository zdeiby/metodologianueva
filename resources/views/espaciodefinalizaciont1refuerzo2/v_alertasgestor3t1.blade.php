...
function verDescripcion(id) {
   ...
   $('#siguiente').click(function(){
        var url = "../rombovisitatipo1refuerzo2/<?= $foliocodificado ?>"; window.location.href = url;
      }); 
      function redirectToIntegrantes() {
           var folio = `<?=$foliocodificado ?>`;
           var url = "../indicadorest1refuerzo2/:folio";
       ...
       $('#bienestarsaludemocionalqt').click(function(){var url = "../ficherodeoportunidadest1refuerzo2/<?= $foliocodificado ?>"; window.location.href = url;})
    $('#legalqt').click(function(){var url = "../ficherodeoportunidadeshogart1refuerzo2/<?= $foliocodificado ?>"; window.location.href = url;})
    $('#indicadores').click(function(){var url = "../indicadorest1refuerzo2/<?= $foliocodificado ?>"; window.location.href = url;})
    $('#alertas').click(function(){var url = "../alertasgestor3t1/<?= $foliocodificado ?>"; window.location.href = url;})
</script>
