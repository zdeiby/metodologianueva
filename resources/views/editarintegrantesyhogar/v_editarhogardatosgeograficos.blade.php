...
<!-- <form class="d-flex pb-4" role="search">
      ...
      <button class="btn btn-outline-success" type="submit">Buscar</button>
        ...
        <div class="accordion-item" id="l1e1">
            ...
            <span class="badge bg-primary" id="">Folio: {{ $variable }}</span>
            </button>
            <!-- <div class="progress">
    ...
    <!-- <div><span class="badge bg-success mt-2" id="folio">Folio: {{ $variable }}</span> -->
    <div>
  ...
  <li class="nav-item" role="presentation">
    <a id="datosgeograficosmenu"  class="nav-link active" style="cursor:pointer">EDICIÓN DATOS GEOGRAFICOS Y ECONÓMICOS</a>
  </li>
  <!-- <li class="nav-item" role="presentation">
...
<div id="myTabContent" class="tab-content"><br>
  ...
  <div class="col-md-3" style="display:none">
            <input type="text" placeholder="folio" class="form-control form-control-sm  " id="folioinput" name="folio" value="{{ $variable }}" required="">
          </div>
          <div class="col-md-3" style="display:none">
   ...
   $(document).ready(function(){
    ...
    let folio=$('#folioinput').val();
      ...
      $('#atras').click(function(){
        window.location.href="../editarintegrantesgeneral/<?= $folio ?>" 
      }); 
      ...
      //      var folio = '<?= $folio ?>';console.log(folio)
      //      var url = "../public/editarintegrantesgeneral/:folio";
