...
<span class="badge bg-warning text-light" style="font-size:15px">Caracterización de hogar</span>
...
<span class="badge bg-warning text-light" style="background:#a80a85 !important; font-size:15px">Caracterización de integrantes</span>
<div id="myTabContent" class="tab-content"><br>
  <div class="tab-pane fade active show" id="home" role="tabpanel" style="overflow-x: auto; ">
...
<script src="{{ asset('assets/jquery/jquery.js') }}"></script>
    <script>
      ...
      $.ajax({
        url:'../index.php/leerintegrantesgeneralffes',
      ...
      function editarintegrantes(folio,idintegrante, folioencriptado){
        ...
        localStorage.setItem('folioencriptado', folioencriptado);
        window.location.href = `../caracterizacion_integrantes/${folio}/${idintegrante}`;
      } 
