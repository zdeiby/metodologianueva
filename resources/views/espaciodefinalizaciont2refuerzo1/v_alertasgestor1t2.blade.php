...
function verDescripcion(id) {
   ...
   $('#siguiente').click(function(){
        var url = "../rombovisitatipo2refuerzo1/<?= $foliocodificado ?>"; window.location.href = url;
      }); 
      function redirectToIntegrantes() {
           var folio = `<?=$foliocodificado ?>`;
           var url = "../indicadorest2refuerzo1/:folio";
       ...
       $('#bienestarsaludemocionalqt').click(function(){var url = "../ficherodeoportunidadest2refuerzo1/<?= $foliocodificado ?>"; window.location.href = url;})
    $('#legalqt').click(function(){var url = "../ficherodeoportunidadeshogart2refuerzo1/<?= $foliocodificado ?>"; window.location.href = url;})
    $('#indicadores').click(function(){var url = "../indicadorest2refuerzo1/<?= $foliocodificado ?>"; window.location.href = url;})
    $('#alertas').click(function(){var url = "../alertasgestor1t2/<?= $foliocodificado ?>"; window.location.href = url;})
</script>
