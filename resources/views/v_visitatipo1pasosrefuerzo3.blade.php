...
@section('title', ' 4ta Visita tipo 1')
          ...
          <div class="card">
            <div class="content">
              ...
              <div class="back">
                ...
                <button type="button" id="gestionintegrantes" <?= (($existel500p50010 == '1' && $existel500p50020 == '0' ) /* || ($existel500p50010 == '1' && $existel500p50030 == '0') || ($existel500p50010 == '1' && $existel500p50040 == '0') */  )?'':'disabled'?>  class="btn btn-primary" onclick="window.location.href='../momentoconcientet1refuerzo3/{{$folioencriptado}}/'">Ir a momento movilizador.</button>
                <div class="smCard">
                </div>
              </div>
            </div>
        ...
        <div class="card_wrapper">
          <div class="card">
            <div class="content">
             ...
             <button type="button" class="btn btn-primary" <?=($existel500p50010 == '1' && $existel500p50020 == '1'  && $existel500p50030 == '1' && $existel500p50040 == '1' && $existel500p50050 == '0' )?'':'disabled'?> onclick="window.location.href='../informevisitat1refuerzo3/{{$folioencriptado}}/'">Ir a finalización</button>
             <div class="smCard">
                </div>
              </div>
            </div>
