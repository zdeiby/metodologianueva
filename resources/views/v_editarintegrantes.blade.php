...
<!-- <form class="d-flex pb-4" role="search">
  ...
  <li class="nav-item" role="presentation">
    <a id="identatario" disabled="" class="nav-link " data-bs-toggle="tab" href="#profile" aria-selected="false" role="tab" tabindex="-1">BIENESTAR INTELECTUAL</a>
  </li>
...
<div id="myTabContent" class="tab-content"><br>
  ...
  <div class="avatar text-center" style="cursor:pointer">
    <img src="{{asset('avatares/1.png')}} " id="imagenDinamica" class="rounded-circle" alt="Avatar" style="width: 150px; height: 150px;" data-bs-toggle="modal" data-bs-target="#exampleModal">
          ...
          <div class="col-md-3">
            <input type="text" class="form-control form-control-sm " placeholder="Nombre 1" id="validationServer01" value="" >
          </div>
          <div class="col-md-3">
            <input type="text" class="form-control form-control-sm " placeholder="Nombre 2" id="validationServer01" value="" required>
          </div>
          <div class="col-md-3">
            <input type="text" class="form-control form-control-sm " placeholder="Apellido 1" id="validationServer01" value="" >
          </div>
          <div class="col-md-3">
            <input type="text" class="form-control form-control-sm " placeholder="Apellido 2" id="validationServer01" value="" required>
          </div>
          <div class="col-md-12">
            ...
            <input type="date" class="form-control form-control-sm "  name="hijos"  id="validationServer01" value="" required>
          </div>
          <div class="col-md-6">
            ...
            <input type="number" class="form-control form-control-sm "  name="hijos"  id="validationServer01" value="" required>
          </div>
          <div class="col-md-4">
  ...
  <div class="col-md-3" style="display:none">
        ...
        <div class="col-md-4">
                  ...
                  <select class="form-control form-control-sm" id="hijos" name="hijos" aria-describedby="validationServer04Feedback" required="">
                  <option selected="" value="">Selecciona</option><option value="1">SI</option><option value="2">NO</option>
                  </select>
                </div>
          ...
          <div class="col-md-4">
            ...
            <option selected="" value="">Selecciona</option><option value="14">Heterosexual</option><option value="15">Bisexual</option><option value="16">Lesbiana</option><option value="17">Gay</option><option value="18">Asexual</option><option value="19">Pansexual</option><option value="20">Otra (habilita campo)</option><option value="21">Prefiere no decirlo</option>
            </select>
          </div>
          <div class="col-md">
          ...
          <div class="col-md-6">
            ...
            <option selected="" value="">Selecciona</option><option value="22">Mujer Cisgénero</option><option value="23">Hombre Cisgénero</option><option value="24">Hombre Transgénero</option><option value="25">Género fluido</option><option value="26">No binario</option><option value="27">Otra (habilita campo)</option><option value="28">Prefiere no identificarse</option>
            </select>
          </div>
          <div class="col-md">
            <label for="validationServer04" class="form-label">¿Cúal?</label>
          ...
          <div class="col-md-6">
            ...
            <select class="form-control form-control-sm" id="etnia" name="etnia" aria-describedby="validationServer04Feedback" required="">
                <option selected="" value="">Selecciona</option><option value="29">Afrocolombiano / Palenquero (San Basilio, San José de Uré, Jacobo Perez Escobar y la Libertad)</option><option value="30">Afrocolombiano / Negro</option><option value="31">Afrocolombiano / Mulato</option><option value="32">Indígena / Pueblo originario</option><option value="33">Raizal</option><option value="34">ROM - Gitano. </option><option value="35">Otro</option><option value="36">Ninguna de las anteriores</option>
            </select>
          </div>
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            ...
            <option selected="" value="">Selecciona</option><option value="37">Cancilleria</option><option value="38">Sedes diplomáticas</option><option value="39">Acnur</option><option value="40">Ong ¿cuál?</option><option value="41">Otro.</option>
            </select>
          </div>
          <hr>
  ...
  <div class="modal-dialog">
    ...
    function cargarImagen(){
      ...
      $.ajax({
        ...
        //  $('#imagenDinamica').attr('src',`https://zdeiby.castelancarpinteyro.com/metodologia/public/avatares/${imagen}.png`);
        //  localStorage.setItem('imagen',`https://zdeiby.castelancarpinteyro.com/metodologia/public/avatares/${imagen}.png`)
    ...
    $(document).ready(function(){
      $('#volveratras').css('display','none');
        ...
        success:function(data){
          ...
          $('#nombreidentitario').val((data.integrantes)?data.integrantes.nombreidentitario:'');
          $('#fechanacimiento').val((data.integrantes)?data.integrantes.fechanacimiento:'');      
          $('#tienenombreidentitario').val((data.integrantes)?data.integrantes.tienenombreidentitario:'');
          $('#documento').val((data.integrantes)?data.integrantes.documento:'');
          $('#paises').val((data.integrantes)?data.integrantes.pais:''); 
          $('#tipodocumento').val((data.integrantes)?data.integrantes.tipodocumento:'');
          $('#representantehogar').val((data.integrantes)?data.integrantes.representantehogar:'');
          ...
          console.log(data.leerintegrantes)
      ...
      function redirectToIntegrantes() {
           ...
           var url = "https://zdeiby.castelancarpinteyro.com/metodologia/public/integrantes/:folio";
